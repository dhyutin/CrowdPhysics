  ...
  return (
    <div className="h-full flex flex-col overflow-hidden">
      ...
      <div className="px-6 py-4 border-b border-border flex-shrink-0"
        style={{ background: "linear-gradient(90deg, rgba(14,165,233,0.04) 0%, transparent 100%)" }}>
      ...
      <div className="flex-1 overflow-hidden flex gap-0">
        ...
        <div className="flex-1 flex flex-col gap-4 p-6 overflow-y-auto">
          ...
          <div className="rounded-xl p-4 border border-amber/25 animate-fade-in"
            style={{ background: "linear-gradient(135deg, rgba(245,158,11,0.07) 0%, rgba(245,158,11,0.03) 100%)" }}>
